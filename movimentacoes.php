...
//-->
  ...
  <?php 
  include("conexao.php");
  $seleciona=mysql_query("SELECT * FROM movestoque ORDER BY idmov DESC");
  while($rows=mysql_fetch_assoc($seleciona)){
	   ?><tr><td><?php echo $rows['data']; ?></td><?php
	  ?><td><?php echo "O usuário ".$rows['feitopor']." ".$rows['movrea']." a quantidade de ".$rows['qtd']." ".$rows['nomeprod']."(".$rows['referencia'].") reduzindo para ".$rows['qtdatual']." disponiveis"; ?></td></tr><?php
  }
  ?>
  </table>
  </div><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  <br><a href="movadm.php">Operações de Reposição</a></h3>
  <?php }else{ echo "<b>Você não tem permissão para acessar esta área!</b>";} ?>
  <br><a href="sistema.php">Voltar a página principal</a></h3></center>
  </div>
  <div id="fundo">
