...
//-->
  ...
  <table id="cadfunc">
  <form  id="cadastrafunc" action="cadfu.php" method="post">
  <tr>
  <td>
  Nome:
  </td><td><input class="func" type="text" name="nome"></td></tr>
  <tr><td>
  Senha:</td><td> <input class="func"type="text" name="senha"></td></tr>
  <tr><td>
  Login:</td><td><input class="func" type="text" name="login"></td></tr>
  <tr><td>
  Cargo:</td><td><select id ="cad" name="cargo">
  ...
  <a href="editafunc.php">Editar usuários</a><br>
