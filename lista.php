...
//-->
  ...
  <div id="conteudo">
  <h3>Lista de Produtos</h3><hr>
   <?php if($_SESSION['cargo']=="admin"){?>
  <div id="roll6">
  <table border="1" id="listaprod">
  <tr>
  ...
  $seleciona=mysql_query("SELECT * FROM produtos");
  while($rows=mysql_fetch_assoc($seleciona)){ ?>
	<tr>
	<td><?php echo $rows['nomeprod']; ?></td>   
	<td><?php echo $rows['modeloprod']; ?></td>  
	<td><?php echo $rows['quantidade']; ?></td>  
	<td><a href="repor.php?id=<?php echo $rows['idprod']; ?>">Repor</a> / <a href="edita.php?id=<?php echo $rows['idprod']; ?>">Editar</a> / <a href="delprod.php?id=<?php echo $rows['idprod']; ?>">Excluir</a></td>
	<?php
  }
  ?>
  </table>
  ...
  </div><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br> <a href='cadprod.php'><h3>Voltar a página anterior</h3></a>
  </div> 
   <div id="lateral">
