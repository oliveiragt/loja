...
<script type="text/javascript" src="javascriptpersonalizado2.js"></script>
  <div id="conteudo">
  <center><h2>Pesquisa por número de referência</h2></center>
  <hr><center>
  <form method="POST" id="form-pesquisa" action="">
			Pesquisar: <input type="text" name="pesquisa" id="pesquisa" placeholder="Pesquisar produto">
		</form>
		<a href="buscanome.php">Busca por nome</a><br>
		<a href="sistema.php">Voltar a pagina principal</a><br>
		<div id="resu">
		<ul class="resultado">
