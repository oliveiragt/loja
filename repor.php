...
//-->
  ...
  <body>
  <div id="conteudo">
  <center><h2>Reposição de Produtos</h2></center>
  <hr><?php 
  if($_SESSION['cargo']=="admin"){
	  ...
	  while($exibe=mysql_fetch_assoc($busca)){
		  echo "Atualmente o produto ".$exibe['nomeprod']." possui ".$exibe['quantidade']." unidades em estoque";
	  ?>
  <table id="tblcadastro">
  <form  id="cadastraprod" action="repos.php" method="post">
  <tr>
  <input type="text" name="id" id="hidde" value="<?php echo $id; ?>" style="display:none">
  <td>Quantidade: <input class="func" type="text" name="qtdrepor"></td></tr>
  <td colspan="2"><center><input class="botao" type="submit" value="Repor"></center></td></tr>
   </form>
