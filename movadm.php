...
<html>
 <head>
  ...
  <meta charset="UTF-8">
  <title>Operações de Reposição</title>
 </head>
...
//-->
  ...
  <body>
  <div id="conteudo">
  <center><h2>Operações de Reposição</h2></center>
  <hr><?php  if($_SESSION['cargo']=="admin"){ ?>
  <center>
  <div id="roll4">
  <table border="1" id="tblmov">
  <?php 
  include("conexao.php");
  $seleciona=mysql_query("SELECT * FROM movadm ORDER BY idmov DESC");
  while($rows=mysql_fetch_assoc($seleciona)){
	   ?><tr><td><?php echo $rows['dia']; ?></td><?php
	  ?><td><?php echo "O usuário ".$rows['feitopor']." ".$rows['tipomov']." a quantidade de ".$rows['quantidade']." ".$rows['nomeprod']."(".$rows['nr']." totalizando ".$rows['qtdatual']." disponiveis"; ?></td></tr><?php
  }
  ?>
  </table>
  </div><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  <?php }else{ echo "<b>Você não tem permissão para acessar esta área!</b>";} ?>
  <br><a href="movimentacoes.php">Voltar a página principal</a></h3></center>
  </div>
  <div id="fundo">
