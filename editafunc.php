...
//-->
  ...
  <div id="conteudo">
  <h3>Editar usuários</h3><hr>
  <?php if($_SESSION['cargo']=="admin"){?>
  <div id="roll5">
  <table border="1" id="listafunc">
  <tr><td><center>Nome</center></td>
  <td><center>Função</center></td>
  <td><center>Ação</center></td></tr>
  <?php include("conexao.php");
  $seleciona=mysql_query("SELECT * FROM usuarios");
  while($rows=mysql_fetch_assoc($seleciona)){ ?>
	<tr><td><?php echo "<center>".$rows['nome']."</center>"; ?></td>
	<td><?php echo "<center>".$rows['cargo']."</center>"; ?></td>  
	<td><center><a href="editaus.php?id=<?php echo $rows['idusuario']; ?>">Editar</a> / <a href="apagauser.php?id=<?php echo $rows['idusuario']; ?>">Apagar</a></center></td>  
	<?php
  }
  ?>
  </table>
  ...
  <a href="cadfunc.php"><h3>Voltar a página anterior</h3></a>
  </div>
   <div id="lateral">
